...
> **Classification rationale:** All four L2 tests explicitly compare the returned value against the device profile (`AudioCapabilities`, `MS12Capabilities`, `MS11Decode`, `MS12Decode` fields). Per the classification rules, this makes the requirement Profile Compliance, not Functional.
